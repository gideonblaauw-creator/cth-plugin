...
name: academy-comms
description: >
  Communications protocol for the Academy Desk. Trigger on CTH Academy or CLP 2026 program comms.
...
- **End clients:** Academy participants, trainers, and CLP26 cohorts. Named contacts: **[PENDIENTE]** per program.
...
`clp26-brand` for CLP26 campaign content; `cleantechhub-brand` for CTH Academy institutional voice.
...
- **Lane A repo / store for this Desk:** `cth-plugin` for skills; program packs in Archive/Drive.
...
Social posts route through **Socials Desk** Workbench after HITL.
