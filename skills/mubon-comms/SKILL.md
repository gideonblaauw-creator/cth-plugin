...
name: mubon-comms
description: >
  Communications protocol for the Mubon Desk. Trigger on Mubon or P4G/MubOn program comms.
...
- **End client / program:** Mubon (P4G/MubOn context in Archive). External contacts: **[PENDIENTE]**.
...
`[PENDIENTE]` — Mubon program brand. No `cleantechhub-brand` leak unless co-branding is explicit.
...
- **Lane A repo / store for this Desk:** Lane B Drive packs unless Gideon marked a repo row.
