...
description: >
  Communications protocol for the Newsletter Desk. Trigger on CTH Newsletter System comms or newsletter drafts.
...
- **End clients:** CleantechHUB newsletter subscribers. Segment contacts: **[PENDIENTE]**.
...
- **Lane A repo / store for this Desk:** Content in Archive/Drive or repo per ticket.
...
Gmail send only via **Inbox Desk** Workbench after HITL.
...
Newsletter send = HITL. Mark draft **Awaiting Gideon's approval**.
