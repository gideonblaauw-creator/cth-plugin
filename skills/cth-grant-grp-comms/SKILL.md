...
description: >
  Communications protocol for the CTH Grant · GRP Desk. Trigger on GRP isolated grant draft comms.
...
- **End client / funder:** GRP grant (isolated live draft). Funder/partner contacts: **[PENDIENTE]**.
...
- **Lane A repo / store for this Desk:** Lane B Drive for grant pack.
