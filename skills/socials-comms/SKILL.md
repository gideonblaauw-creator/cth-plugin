...
name: socials-comms
description: >
  Communications protocol for the Socials Desk. Trigger on CTH Socials Desk comms, social posts, or channel coordination.
...
- **End clients:** CleantechHUB and partner-brand audiences on social channels. Named partner contacts: **[PENDIENTE]** per campaign.
...
`cleantechhub-brand` default; `clp26-brand` for CLP26 campaign; partner brands per campaign — no cross-leak.
...
- **Lane A repo / store for this Desk:** `cth-plugin` for skills/playbooks; content calendar in Notion/Buffer (Tools).
...
**LinkedIn, Instagram, Facebook, Google Ads** Workbenches (this Desk only): post/DM/spend when Hands cannot. HITL before post/DM/spend/launch/pause.
