...
name: app-build
description: >
  Blaauw app-build protocol for promoting trees to GitHub. Use when: app-build,
  promote to GitHub, create a repo, new repo, Infrastructure classifies, or
  pushing a service/app/pipeline to GitHub. Do not use when: grant packs (Drive)
  or skill-only edits.
license: MIT
metadata:
  version: "1.1.0"
...
| Skill | When instead |
|---|---|
| `harness` | Lane A repo lock and Hands tickets |
| `skill-template` | Authoring new skills in cth-plugin |
