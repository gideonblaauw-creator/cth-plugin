...
description: >
  Communications protocol for the Chamber · Bucaramanga Desk. Trigger on Cámara de Comercio Bucaramanga comms (single Desk — not split).
...
- **End client:** Cámara de Comercio de Bucaramanga. Named contacts: **[PENDIENTE]**.
...
`cleantechhub-brand` for CTH voice in chamber partnership comms unless chamber co-branding is explicit.
...
- **Lane A repo / store for this Desk:** Archive/Drive per ticket.
