...
name: aic-comms
description: >
  Communications protocol for the AIC Desk. Trigger on AIC, Bravo Bridge, or Americas Innovation Council comms.
...
- **End client / partners:** Americas Innovation Council (AIC) / Bravo Bridge. Named contact: **Frank** (US-facing).
...
`[PENDIENTE]` — AIC / Bravo Bridge brand (isolated from `cleantechhub-brand`). Per `skills/app-build/SKILL.md`: do not mix CTH lime into AIC.
...
- **Lane A repo / store for this Desk:** `https://github.com/gideonblaauw-creator/americas-innovation-hub`
