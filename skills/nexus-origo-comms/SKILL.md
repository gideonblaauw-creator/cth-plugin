...
description: >
  Communications protocol for the Nexus/Origo Desk. Trigger on Nexus portfolio or Origo/Climate Data Platform comms.
...
- **End clients:** Startup founders (Nexus), data partners (Origo / Climate Data Platform). Named contacts: **[PENDIENTE]** per startup/partner.
...
`cleantechhub-brand` for Nexus/CTH platform voice. Startup pages at nexus.cleantechhub.net.
...
- **Lane A repo / store for this Desk:** Nexus deploys via `skills/nexus-onepager/SKILL.md`; Origo per Infrastructure classify.
