...
name: canva
description: >
  Exports Canva designs and prepares images for downstream tools. Use when:
  Canva, design export, social visuals from Canva, posting Canva images.
  Sequencing and URL rules apply.
license: MIT
metadata:
  version: "2.1.0"
  category: "operations"
