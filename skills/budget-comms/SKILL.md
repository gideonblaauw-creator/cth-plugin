...
name: budget-comms
description: >
  Communications protocol for the Budget Desk. Trigger on CTH 2026 Budget Desk comms.
...
- **End clients:** CTH internal finance stakeholders and funders requiring budget correspondence. Named contacts: **[PENDIENTE]**.
...
`cleantechhub-brand` for CTH institutional budget comms.
...
- **Lane A repo / store for this Desk:** Lane B Drive / Archive for xlsx packs.
...
Do not share draft budgets externally without Gideon yes.
