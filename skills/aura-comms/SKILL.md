...
name: aura-comms
description: >
  Communications protocol for the AURA Desk. Trigger on AuRA funder or AURA Desk comms.
...
- **End client / funder:** AuRA (listed in `skills/cth-grant/SKILL.md` funder set). Funder contacts: **[PENDIENTE]**.
...
`cleantechhub-brand` for CTH-signed donor comms. No client-brand leak.
...
- **Lane A repo / store for this Desk:** Grant packs → Lane B Drive. Harness/docs → `cth-plugin`.
