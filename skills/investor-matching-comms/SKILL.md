...
description: >
  Communications protocol for the Investor Matching Desk. Trigger on Investor Matching Desk comms.
...
- **End clients:** Investors and startup founders in matching flows. Named contacts: **[PENDIENTE]** per deal.
...
`cleantechhub-brand` for CTH-facilitated intros. Startup materials follow Nexus/startup context — no client-brand leak.
...
- **Lane A repo / store for this Desk:** Archive or `cth-plugin` per ticket.
...
No investor intro sent without Gideon yes.
