...
3. Require `langgraph: yes` on the ticket. Launch Composer 2.5 Fast ON for builds (t1263u). OpenCode is OSS experiments only. Never silently launch with Fast off.
