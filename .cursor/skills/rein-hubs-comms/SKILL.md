...
This file is a Cursor discovery stub. The playbook source of truth is `skills/rein-hubs-comms/SKILL.md`.

1. Read `skills/rein-hubs-comms/SKILL.md` before doing the work.
