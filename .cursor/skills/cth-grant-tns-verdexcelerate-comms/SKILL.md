...
This file is a Cursor discovery stub. The playbook source of truth is `skills/cth-grant-tns-verdexcelerate-comms/SKILL.md`.

1. Read `skills/cth-grant-tns-verdexcelerate-comms/SKILL.md` before doing the work.
